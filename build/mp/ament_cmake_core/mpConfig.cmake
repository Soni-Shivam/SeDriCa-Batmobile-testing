...
if(_mp_CONFIG_INCLUDED)
  # ensure to keep the found flag the same
  if(NOT DEFINED mp_FOUND)
...
set(_mp_CONFIG_INCLUDED TRUE)

# output package information
if(NOT mp_FIND_QUIETLY)
  message(STATUS "Found mp: 0.0.0 (${mp_DIR})")
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "Package 'mp' is deprecated")
  # append custom deprecation text if available
  if(NOT "" STREQUAL "TRUE")
    set(_msg "${_msg} ()")
  endif()
  # optionally quiet the deprecation message
  if(NOT ${mp_DEPRECATED_QUIET})
    message(DEPRECATION "${_msg}")
  endif()
endif()

# flag package as ament-based to distinguish it after being find_package()-ed
set(mp_FOUND_AMENT_PACKAGE TRUE)
